...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".sTradingviewContent[data-v-a8ec70b2]{height:100%;width:100%}.sTradingviewContent .tabsWrap[data-v-a8ec70b2]{height:88px}", ""]);
// Exports
...
var unsupportedIterableToArray = __webpack_require__(1332);
...
var getPrototypeOf = __webpack_require__(6814);

var isNativeReflectConstruct = __webpack_require__(8873);

var possibleConstructorReturn = __webpack_require__(1316);
...
var setPrototypeOf = __webpack_require__(8368);
...
var assertThisInitialized = __webpack_require__(6763);
...
var arrayLikeToArray = __webpack_require__(2658);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _createForOfIteratorHelper = (__webpack_require__(7786)["default"]);

var _classCallCheck = (__webpack_require__(5205)["default"]);

var _createClass = (__webpack_require__(8498)["default"]);
...
!function (e, t) {
  ...
  function t(e, i) {
    ...
    for (var _o in i) {
      "object" != _typeof(e[_o]) || null === e[_o] || Array.isArray(e[_o]) ? void 0 !== i[_o] && (n[_o] = i[_o]) : n[_o] = t(e[_o], i[_o]);
    }
  ...
  var s = /*#__PURE__*/function () {
    function s(e) {
      ...
      if (this._id = "tradingview_".concat((1048576 * (1 + Math.random()) | 0).toString(16).substring(1)), this._ready = !1, this._readyHandlers = [], this._onWindowResize = this._autoResizeChart.bind(this), !e.datafeed) throw new Error("Datafeed is not defined");

      if (this._options = t(n, e), e.preset) {
        var _t = i[e.preset];
        _t ? (void 0 !== this._options.disabled_features ? this._options.disabled_features = this._options.disabled_features.concat(_t.disabled_features) : this._options.disabled_features = _t.disabled_features, void 0 !== this._options.enabled_features ? this._options.enabled_features = this._options.enabled_features.concat(_t.enabled_features) : this._options.enabled_features = _t.enabled_features) : console.warn("Unknown preset: `" + e.preset + "`");
      }
    ...
    _createClass(s, [{
      ...
      value: function onGrayedObjectClicked(e) {
        this._innerAPI().onGrayedObjectClicked(e);
      }
    }, {
      key: "onShortcut",
      value: function onShortcut(e, t) {
      ...
      key: "setSymbol",
      value: function setSymbol(e, t, i) {
      ...
      key: "selectLineTool",
      value: function selectLineTool(e) {
      ...
      value: function showNoticeDialog(e) {
        this._innerAPI().showNoticeDialog(e);
      }
    }, {
      key: "showConfirmDialog",
      value: function showConfirmDialog(e) {
      ...
      value: function addCustomCSSFile(e) {
      ...
      value: function applyStudiesOverrides(e) {
      ...
      key: "changeTheme",
      value: function changeTheme(e, t) {
      ...
      key: "drawOnAllCharts",
      value: function drawOnAllCharts(e) {
      ...
      value: function setIntervalLinkingEnabled(e) {
        this._innerAPI().setIntervalLinkingEnabled(e);
      }
    }, {
      key: "setTimeFrame",
      value: function setTimeFrame(e) {
      ...
      value: function takeClientScreenshot(e) {
      ...
      value: function _create() {
        ...
        var t = this._options.container_id || this._options.container,
            i = "string" == typeof t ? document.getElementById(t) : t;
        if (null === i) throw new Error("There is no such element - #".concat(this._options.container));
        i.innerHTML = e, this._iFrame = i.querySelector("#".concat(this._id));
        var n = this._iFrame;
        (this._options.autosize || this._options.fullscreen) && (n.style.width = "100%", this._options.fullscreen || (n.style.height = "100%")), window.addEventListener("resize", this._onWindowResize), this._onWindowResize(), this._innerWindowLoaded = new Promise(function (e) {
          var t = function t() {
          ...
          _this2._innerWindow().widgetReady(function () {
            _this2._ready = !0;

            var _iterator = _createForOfIteratorHelper(_this2._readyHandlers),
                _step;
            ...
            _this2._innerWindow().initializationFinished();
          });
        });
      }
    }, {
  ...
  window.TradingView = window.TradingView || {}, window.TradingView.version = o, e.version = o, e.widget = s, Object.defineProperty(e, "__esModule", {
    value: !0
  });
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var _inherits = (__webpack_require__(9641)["default"]);

var _createSuper = (__webpack_require__(7762)["default"]);

var _createForOfIteratorHelper = (__webpack_require__(7786)["default"]);
...
!function (e, s) {
  "object" == ( false ? 0 : _typeof(exports)) && "undefined" != "object" ? s(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (s),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : 0;
}(this, function (e) {
  ...
  var t = /*#__PURE__*/function () {
    ...
    _createClass(t, [{
      ...
      value: function getBars(e, _t, r) {
        ...
        return void 0 !== r.countBack && (o.countback = r.countBack), void 0 !== e.currency_code && (o.currencyCode = e.currency_code), void 0 !== e.unit_id && (o.unitId = e.unit_id), new Promise(function (e, _t2) {
          _this._requester.sendRequest(_this._datafeedUrl, "history", o).then(function (s) {
            if ("ok" !== s.s && "no_data" !== s.s) return void _t2(s.errmsg);
            var r = [],
                o = {
              noData: !1
            };
            if ("no_data" === s.s) o.noData = !0, o.nextTime = s.nextTime;else {
              ...
              for (var _o = 0; _o < s.t.length; ++_o) {
                var _i = {
                  time: 1e3 * s.t[_o],
                  close: parseFloat(s.c[_o]),
                  open: parseFloat(s.c[_o]),
                  high: parseFloat(s.c[_o]),
                  low: parseFloat(s.c[_o])
                };
                _t4 && (_i.open = parseFloat(s.o[_o]), _i.high = parseFloat(s.h[_o]), _i.low = parseFloat(s.l[_o])), _e && (_i.volume = parseFloat(s.v[_o])), r.push(_i);
              }
            }
            e({
              bars: r,
            ...
            var r = s(e);
            console.warn("HistoryProvider: getBars() failed, error=".concat(r)), _t2(r);
          });
        });
      }
    }]);
  ...
  var r = /*#__PURE__*/function () {
    ...
    _createClass(r, [{
      key: "subscribeBars",
      value: function subscribeBars(e, s, t, _r) {
        this._subscribers.hasOwnProperty(_r) || (this._subscribers[_r] = {
          lastBarTime: null,
          listener: t,
          resolution: s,
          symbolInfo: e
      ...
      key: "unsubscribeBars",
      value: function unsubscribeBars(e) {
      ...
      value: function _updateData() {
        ...
        if (!(this._requestsPending > 0)) {
          ...
          for (var _e2 in this._subscribers) {
            this._requestsPending += 1, this._updateDataForSubscriber(_e2).then(function () {
              _this2._requestsPending -= 1, _this2._requestsPending;
            }).catch(function (e) {
              _this2._requestsPending -= 1, s(e), _this2._requestsPending;
            });
          }
        }
      }
    }, {
      key: "_updateDataForSubscriber",
      value: function _updateDataForSubscriber(e) {
        var _this3 = this;

        var s = this._subscribers[e],
        ...
        return this._historyProvider.getBars(s.symbolInfo, s.resolution, {
          ...
          _this3._onSubscriberDataReceived(e, s);
        });
      }
    }, {
      key: "_onSubscriberDataReceived",
      value: function _onSubscriberDataReceived(e, s) {
        if (!this._subscribers.hasOwnProperty(e)) return;
        var t = s.bars;
        if (0 === t.length) return;
        var _r3 = t[t.length - 1],
            o = this._subscribers[e];
        if (null !== o.lastBarTime && _r3.time < o.lastBarTime) return;

        if (null !== o.lastBarTime && _r3.time > o.lastBarTime) {
          if (t.length < 2) throw new Error("Not enough bars in history for proper pulse update. Need at least 2.");
          var _e3 = t[t.length - 2];
          o.listener(_e3);
        }

        o.lastBarTime = _r3.time, o.listener(_r3);
      }
    }]);
  ...
  var o = /*#__PURE__*/function () {
    ...
    _createClass(o, [{
      key: "subscribeQuotes",
      value: function subscribeQuotes(e, s, t, r) {
        this._subscribers[r] = {
          symbols: e,
          fastSymbols: s,
          listener: t
      ...
      value: function unsubscribeQuotes(e) {
        delete this._subscribers[e];
      }
    }, {
      key: "_updateQuotes",
      value: function _updateQuotes(e) {
        ...
        if (!(this._requestsPending > 0)) {
          var _loop = function _loop(_t5) {
            _this4._requestsPending++;
            var r = _this4._subscribers[_t5];

            _this4._quotesProvider.getQuotes(1 === e ? r.fastSymbols : r.symbols).then(function (e) {
              _this4._requestsPending--, _this4._subscribers.hasOwnProperty(_t5) && (r.listener(e), _this4._requestsPending);
            }).catch(function (e) {
              _this4._requestsPending--, s(e), _this4._requestsPending;
            });
          };

          for (var _t5 in this._subscribers) {
            _loop(_t5);
          }
        }
      }
  ...
  var a = /*#__PURE__*/function () {
    function a(e, s, t) {
      ...
      this._exchangesList = ["NYSE", "FOREX", "AMEX"], this._symbolsInfo = {}, this._symbolsList = [], this._datafeedUrl = e, this._datafeedSupportedResolutions = s, this._requester = t, this._readyPromise = this._init(), this._readyPromise.catch(function (e) {
        console.error("SymbolsStorage: Cannot init, error=".concat(e.toString()));
      });
    }

    _createClass(a, [{
      key: "resolveSymbol",
      value: function resolveSymbol(e, s, t) {
        var _this5 = this;

        return this._readyPromise.then(function () {
          var r = _this5._symbolsInfo[n(e, s, t)];
      ...
      key: "searchSymbols",
      value: function searchSymbols(e, s, t, r) {
        var _this6 = this;
        ...
        return this._readyPromise.then(function () {
          ...
          var _iterator = _createForOfIteratorHelper(_this6._symbolsList),
              _step;

          try {
            var _loop2 = function _loop2() {
              var r = _step.value;
              var n = _this6._symbolsInfo[r];
              if (void 0 === n) return "continue";
              if (t.length > 0 && n.type !== t) return "continue";
              if (s && s.length > 0 && n.exchange !== s) return "continue";

              var _a = n.name.toUpperCase().indexOf(e),
                  u = n.description.toUpperCase().indexOf(e);

              if (i || _a >= 0 || u >= 0) {
                if (!o.some(function (e) {
                  return e.symbolInfo === n;
                })) {
                  var _e4 = _a >= 0 ? _a : 8e3 + u;
      ...
      value: function _init() {
        ...
        var _iterator2 = _createForOfIteratorHelper(this._exchangesList),
            _step2;

        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _t6 = _step2.value;
            s[_t6] || (s[_t6] = !0, e.push(this._requestExchangeData(_t6)));
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
        ...
        return Promise.all(e).then(function () {
          _this7._symbolsList.sort();
        });
      }
    }, {
      key: "_requestExchangeData",
      value: function _requestExchangeData(e) {
        var _this8 = this;

        return new Promise(function (t, r) {
          _this8._requester.sendRequest(_this8._datafeedUrl, "symbol_info", {
            group: e
          }).then(function (s) {
            try {
              _this8._onExchangeDataReceived(e, s);
            } catch (o) {
              return void r(o);
            }
      ...
      key: "_onExchangeDataReceived",
      value: function _onExchangeDataReceived(e, s) {
        var t = 0;

        try {
          var _e5 = s.symbol.length,
              _r4 = void 0 !== s.ticker;

          for (; t < _e5; ++t) {
            var _e6 = s.symbol[t],
                _o2 = i(s, "exchange-listed", t),
                _a3 = i(s, "exchange-traded", t),
                _c = _a3 + ":" + _e6,
                _h = i(s, "currency-code", t),
                _l = i(s, "unit-id", t),
                d = _r4 ? i(s, "ticker", t) : _e6,
                _ = {
              ticker: d,
              name: _e6,
              base_name: [_o2 + ":" + _e6],
            ...
            this._symbolsInfo[d] = _, this._symbolsInfo[_e6] = _, this._symbolsInfo[_c] = _, void 0 === _h && void 0 === _l || (this._symbolsInfo[n(d, _h, _l)] = _, this._symbolsInfo[n(_e6, _h, _l)] = _, this._symbolsInfo[n(_c, _h, _l)] = _), this._symbolsList.push(_e6);
          }
        } catch (r) {
          throw new Error("SymbolsStorage: API error when processing exchange ".concat(e, " symbol #").concat(t, " (").concat(s.symbol[t], "): ").concat(r.message));
        }
      }
    }]);
  ...
  var h = /*#__PURE__*/function () {
    ...
    _createClass(h, [{
      key: "getQuotes",
      value: function getQuotes(e) {
        var _this9 = this;

        return new Promise(function (t, r) {
          _this9._requester.sendRequest(_this9._datafeedUrl, "quotes", {
            symbols: e
          }).then(function (e) {
            "ok" === e.s ? t(e.d) : r(e.errmsg);
          }).catch(function (e) {
            var t = s(e);
            r("network error: ".concat(t));
          });
        });
      }
    }]);
  ...
  var l = /*#__PURE__*/function () {
    ...
    _createClass(l, [{
      key: "sendRequest",
      value: function sendRequest(e, s, t) {
        if (void 0 !== t) {
          var _e7 = Object.keys(t);

          0 !== _e7.length && (s += "?"), s += _e7.map(function (e) {
            return "".concat(encodeURIComponent(e), "=").concat(encodeURIComponent(t[e].toString()));
          }).join("&");
        }
        ...
        return void 0 !== this._headers && (r.headers = this._headers), fetch("".concat(e, "/").concat(s), r).then(function (e) {
          return e.text();
        }).then(function (e) {
          return JSON.parse(e);
        });
  ...
  e.UDFCompatibleDatafeed = /*#__PURE__*/function (_ref) {
    _inherits(_class, _ref);

    var _super = _createSuper(_class);

    function _class(e) {
      var s = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1e4;

      _classCallCheck(this, _class);

      var t = new l();
      return _super.call(this, e, new h(e, t), t, s);
    }

    return _class;
  }( /*#__PURE__*/function () {
    function _class2(e, s, i) {
      var _this10 = this;

      var n = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1e4;
      ...
      this._configuration = {
        ...
        null === e && (e = {
          ...
          supports_marks: !1,
          supports_timescale_marks: !1
        }), _this10._setupWithConfiguration(e);
      });
    }
    ...
    _createClass(_class2, [{
      ...
      value: function onReady(e) {
        ...
        this._configurationReadyPromise.then(function () {
          e(_this11._configuration);
        });
      }
    }, {
      key: "getQuotes",
      value: function getQuotes(e, s, t) {
      ...
      key: "getMarks",
      value: function getMarks(e, t, r, o, i) {
        ...
        this._send("marks", n).then(function (e) {
          if (!Array.isArray(e)) {
            var _s = [];

            for (var _t7 = 0; _t7 < e.id.length; ++_t7) {
              _s.push({
                id: c(e, "id", _t7),
                time: c(e, "time", _t7),
                color: c(e, "color", _t7),
                text: c(e, "text", _t7),
                label: c(e, "label", _t7),
                labelFontColor: c(e, "labelFontColor", _t7),
                minSize: c(e, "minSize", _t7)
              });
            }
      ...
      value: function getTimescaleMarks(e, t, r, o, i) {
        ...
        this._send("timescale_marks", n).then(function (e) {
          if (!Array.isArray(e)) {
            var _s2 = [];

            for (var _t8 = 0; _t8 < e.id.length; ++_t8) {
              _s2.push({
                id: c(e, "id", _t8),
                time: c(e, "time", _t8),
                color: c(e, "color", _t8),
                label: c(e, "label", _t8),
                tooltip: c(e, "tooltip", _t8)
              });
            }
      ...
      key: "getServerTime",
      value: function getServerTime(e) {
        this._configuration.supports_time && this._send("time").then(function (s) {
          var t = parseInt(s);
          isNaN(t) || e(t);
        }).catch(function (e) {
          s(e);
      ...
      key: "searchSymbols",
      value: function searchSymbols(e, t, r, o) {
        if (this._configuration.supports_search) {
          ...
          this._send("search", _i2).then(function (e) {
      ...
      key: "resolveSymbol",
      value: function resolveSymbol(e, t, r, o) {
        var i = o && o.currencyCode,
            n = o && o.unitId;
        ...
        if (this._configuration.supports_group_request) {
          ...
          void 0 !== i && (_t9.currencyCode = i), void 0 !== n && (_t9.unitId = n), this._send("symbols", _t9).then(function (e) {
      ...
      key: "getBars",
      value: function getBars(e, s, t, r, o) {
        this._historyProvider.getBars(e, s, t).then(function (e) {
          r(e.bars, e.meta);
        }).catch(o);
      }
    }, {
      key: "subscribeBars",
      value: function subscribeBars(e, s, t, r, o) {
      ...
      key: "_requestConfiguration",
      value: function _requestConfiguration() {
      ...
      key: "_send",
      value: function _send(e, s) {
        return this._requester.sendRequest(this._datafeedURL, e, s);
      }
    }, {
      key: "_setupWithConfiguration",
      value: function _setupWithConfiguration(e) {
...
// load the styles
var content = __webpack_require__(6500);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(7960)/* ["default"] */ .Z)
var update = add("6a2f8c1d", content, true, {"sourceMap":false,"shadowMode":false});
...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"57f9f194-vue-loader-template"}!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/TV/tradingView.vue?vue&type=template&id=a8ec70b2&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"sTradingviewContent"},[_c('div',{style:({ width: _vm.width, height: _vm.height }),attrs:{"id":_vm.domId}})])}
var staticRenderFns = []
...
// EXTERNAL MODULE: ./src/components/TV/static/charting_library.js
var charting_library = __webpack_require__(5326);
// EXTERNAL MODULE: ./src/components/TV/static/dataFeed.js
var dataFeed = __webpack_require__(6467);
;// CONCATENATED MODULE: ./src/components/TV/config/enabled_features.js
var data = ["adaptive_logo", //小屏幕上隐藏 'charts byTradingView' 文本
...
/* harmony default export */ var enabled_features = (data);
;// CONCATENATED MODULE: ./src/components/TV/config/disabled_features.js
var disabled_features_data = ["widget_logo", "symbol_info", //商品信息对话框
...
"pane_context_menu", "contextmenu", "scales_context_menu", "legend_context_menu", "display_market_status", "timeframes_toolbar", //底部时间栏
...
// "legend_widget",// 禁用此功能会隐藏图例窗口小部件
"header_layouttoggle", //显示标题中的“选择布局”按钮
"header_fullscreen_button", //全屏按钮
// "header_indicators", //指标
// "header_chart_type",//图表类型切换
'header_symbol_search', // 头部搜索
"symbol_search_hot_key" // "header_widget",//隐藏头部的组件dom
// "header_widget_dom_node", // 隐藏头部组件
// "header_interval_dialog_button",
// "show_interval_dialog_on_key_press",
// "snapshot_trading_drawings",
];
/* harmony default export */ var disabled_features = (disabled_features_data);
;// CONCATENATED MODULE: ./src/components/TV/config/studies_overrides.js
var studies_overrides_data = {
  //柱状图颜色
  "volume.volume.color.0": "rgba(255, 15, 93,0.6)",
  //第一根的颜色
  "volume.volume.color.1": "rgba(21,195,34,0.6)" //第二根的颜色
...
/* harmony default export */ var studies_overrides = (studies_overrides_data);
;// CONCATENATED MODULE: ./src/components/TV/config/overrides.js
//自定义默认样式
var defaults = {
  style: {
    up: "#178025",
  ...
  obj: function obj() {
    return {
      ...
      //指标区域大小（large, medium, small, tiny）
      "scalesProperties.lineColor": this.style.text,
      "scalesProperties.textColor": this.style.text,
      "paneProperties.background": this.style.bg,
      //整体背景颜色
      "paneProperties.vertGridProperties.color": this.style.grid,
      //竖直网格线颜色
      "paneProperties.horzGridProperties.color": this.style.grid,
      //水平网格线颜色
...
var overrides_data = {
  ...
  obj: function obj() {
    return {
      ...
      "volumePaneSize": "tiny",
      //底部视图大小 支持的值: large, medium, small, tiny
...
/* harmony default export */ var overrides = (overrides_data.obj());
;// CONCATENATED MODULE: ./src/components/TV/config/loading_screen.js
var loading_screen_data = {
  backgroundColor: "#1e222d",
  foregroundColor: "#5d7d93"
};
/* harmony default export */ var loading_screen = (loading_screen_data);
;// CONCATENATED MODULE: ./src/components/TV/config/index.js
//启用的功能
 //面板上禁用的功能
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-80[0].rules[0].use[1]!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/TV/tradingView.vue?vue&type=script&lang=js&
...
/* harmony default export */ var tradingViewvue_type_script_lang_js_ = ({
  name: 'TV',
  props: {
    //Dom元素id
    domId: {
  ...
  watch: {
    symbolName: function symbolName(v) {
      var _this = this;
  ...
  methods: {
    initDataFeed: function initDataFeed() {
      //加载K线图
      if (!this.url_UDF) {
    ...
    loadChart: function loadChart() {
      ...
      var self = this;
      this.chart = new charting_library.widget(_objectSpread2(_objectSpread2({
...
;// CONCATENATED MODULE: ./src/components/TV/tradingView.vue?vue&type=script&lang=js&
 /* harmony default export */ var TV_tradingViewvue_type_script_lang_js_ = (tradingViewvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-style-loader/index.js??clonedRuleSet-72[0].rules[0].use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-72[0].rules[0].use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-72[0].rules[0].use[2]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-72[0].rules[0].use[3]!./node_modules/less-loader/dist/cjs.js??clonedRuleSet-72[0].rules[0].use[4]!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/TV/tradingView.vue?vue&type=style&index=0&id=a8ec70b2&lang=less&scoped=true&
var tradingViewvue_type_style_index_0_id_a8ec70b2_lang_less_scoped_true_ = __webpack_require__(9324);
;// CONCATENATED MODULE: ./src/components/TV/tradingView.vue?vue&type=style&index=0&id=a8ec70b2&lang=less&scoped=true&
...
;// CONCATENATED MODULE: ./src/components/TV/tradingView.vue
...
var component = normalizeComponent(
  TV_tradingViewvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var tradingView = (component.exports);
;// CONCATENATED MODULE: ./src/index.js




var compon = [tradingView];

var install = function install(Vue) {
  compon.forEach(function (component) {
